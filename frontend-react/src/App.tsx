...
function App() {
  ...
  const mainMenu = [
    ...
    { name: 'Human Review', path: '/review', icon: <Sparkles size={18} />, badge: 'new' },
      ...
      <div className="min-h-screen bg-[#f8f9fc] flex text-slate-800 font-sans selection:bg-blue-100 selection:text-blue-900">
        ...
        <aside className="w-[260px] bg-transparent flex flex-col pt-8 pl-6 pr-4 flex-shrink-0 h-screen sticky top-0">
          <div className="mb-10 flex items-center gap-3">
            ...
            <div>
              <h2 className="text-[16px] font-bold text-slate-900 tracking-tight leading-tight">ProspectKeeper</h2>
              <p className="text-[11px] font-mono text-slate-500 tracking-tight font-semibold uppercase">agentic-crm-v1</p>
            </div>
          </div>
          ...
          <nav className="flex-1 overflow-y-auto space-y-8">
            <div className="space-y-1.5">
              {mainMenu.map((item) => (
                <NavLink
                  ...
                  to={item.path}
                  className={({ isActive }) =>
                    `group flex items-center gap-3 px-3 py-2.5 rounded border ${isActive && item.path !== '#'
                ...
                >
                  <div className={`transition-colors ${item.path !== '#' ? 'group-hover:text-slate-700' : ''}`}>
                    {item.icon}
                  </div>
            ...
            <div className="pt-6 border-t border-slate-200/60">
              <div className="bg-white rounded p-4 border border-slate-200">
                <h3 className="text-[12px] font-bold text-slate-800 mb-1">Background Sync</h3>
          ...
          <div className="max-w-[1200px] mx-auto relative z-10">
            ...
            <header className="mb-8 flex items-center justify-between bg-white rounded p-4 shadow-sm border border-slate-200">
              <div className="flex items-center gap-3 pl-4">
                ...
                <input type="text" placeholder="Search anything..." className="bg-transparent border-none outline-none text-[13px] font-medium text-slate-700 placeholder:text-slate-400 w-[300px]" />
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4">
          <div className="bg-white rounded-lg shadow-xl border border-slate-200 w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
              <h3 className="text-[16px] font-bold text-slate-900">Add New Contact</h3>
              <button
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input type="text" placeholder="e.g. Jane Doe" className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded text-[13px] focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all shadow-sm" />
              </div>
              <div>
                <label className="block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Email Address</label>
                <input type="email" placeholder="jane@example.com" className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded text-[13px] focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all shadow-sm" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Job Title</label>
                  <input type="text" placeholder="e.g. Director of Sales" className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded text-[13px] focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all shadow-sm" />
                </div>
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Organization</label>
                  <input type="text" placeholder="e.g. Acme Corp" className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded text-[13px] focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all shadow-sm" />
                </div>
              </div>
              <div>
                <label className="block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-1.5 flex items-center gap-2">LinkedIn URL <span className="text-[9px] bg-slate-100 text-slate-400 px-1.5 py-0.5 rounded">Optional</span></label>
                <input type="url" placeholder="https://linkedin.com/in/..." className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded text-[13px] focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-mono shadow-sm" />
              </div>
            </div>
            ...
            <div className="px-6 py-4 border-t border-slate-100 bg-slate-50/50 flex justify-end gap-3">
              ...
              <button
                onClick={() => setIsAddModalOpen(false)}
                className="px-5 py-2.5 bg-blue-600 text-white rounded text-[13px] font-bold hover:bg-blue-700 shadow-sm transition-colors"
              >
                Save Contact
              </button>
            </div>
